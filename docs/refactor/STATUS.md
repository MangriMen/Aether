...
причине — ручной сценарий требует GUI и плагина из GitHub-релиза; по итогам T-0.6 заведена
T-1.5.C (packwiz всё ещё ходит через встроенный `http_request`, см. F-16), по итогам T-0.2 —
T-0.2.A (пометка «не верифицирован» в UI, см. F-19); реализация остальных задач не начиналась.
...
| T-1.4 | Декларация `api.hostFunctions` в манифесте | aether + packwiz | 1.4 | T-1.1, T-1.2, T-1.3 | Opus | да | not_started |
