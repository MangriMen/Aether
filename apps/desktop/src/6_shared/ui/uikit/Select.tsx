...
const SelectTrigger = <T extends ValidComponent = 'button'>(
  ...
  return (
    <SelectPrimitive.Trigger
      class={cn(
        'flex h-10 w-full items-center justify-between data-[invalid]:border-destructive rounded-md border  bg-secondary/secondary enabled:hover:bg-secondary/hover px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50',
        local.class,
      )}
      {...others}
    >
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        class={cn(
          'relative z-50 min-w-32 overflow-hidden rounded-md border  bg-popover/hard text-popover-foreground shadow-lg origin-[var(--kb-select-content-transform-origin)] animate-content-hide data-[expanded]:animate-content-show',
          local.class,
          {
...
const SelectItem = <T extends ValidComponent = 'li'>(
  ...
  return (
    <SelectPrimitive.Item
      class={cn(
        'relative mt-0 flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm outline-none hover:bg-secondary/hover hover:text-foreground focus:bg-secondary/control focus:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
        local.class,
      )}
      {...others}
    >
