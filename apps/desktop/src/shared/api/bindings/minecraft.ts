...
export const commands = {
	getMinecraftVersionManifest: () => __TAURI_INVOKE<VersionManifestDto>("plugin:minecraft|get_minecraft_version_manifest"),
	getLoaderVersionManifest: (loader: ModLoaderDto) => __TAURI_INVOKE<ModdedManifestDto>("plugin:minecraft|get_loader_version_manifest", { loader }),
};
...
export type ModdedLoaderVersionDto = {
