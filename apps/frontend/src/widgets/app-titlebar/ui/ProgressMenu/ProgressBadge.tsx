...
export const ProgressBadge: Component<ProgressBadgeProps> = (props) => {
  ...
  return (
    <div
      class={cn(
        `
          relative h-2 w-full overflow-hidden rounded-md border
    ...
    >
      ...
      <div
        class='
          absolute -top-4.5 -left-5.5 aspect-square w-[130%] animate-spin
          rounded-[110%_30%_80%_20%/40%_90%_40%_60%] bg-green-500
