...
const Checkbox = <T extends ValidComponent = 'div'>(
  ...
  return (
    ...
    >
      ...
      <CheckboxPrimitive.Control class='size-4 shrink-0 rounded-sm border border-border-dynamic/15 bg-secondary/control ring-offset-background transition-colors hover:border-border-dynamic/25 hover:bg-secondary/hover active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 peer-focus-visible:outline-none peer-focus-visible:ring-2 peer-focus-visible:ring-ring peer-focus-visible:ring-offset-0 data-[checked]:border-none data-[checked]:bg-primary data-[checked]:text-primary-foreground data-[checked]:brightness-110 data-[checked]:hover:bg-primary/solid-hover'>
